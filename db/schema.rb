...
ActiveRecord::Schema[8.1].define(version: 2026_02_20_100000) do
  ...
  create_table "notification_emails", force: :cascade do |t|
    ...
    t.integer "notify_hour", default: 0, null: false
    t.datetime "updated_at", null: false
    t.bigint "user_id", null: false
  ...
  create_table "proxy_required_domains", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.string "domain", null: false
    t.datetime "updated_at", null: false
    t.index ["domain"], name: "index_proxy_required_domains_on_domain", unique: true
  end
